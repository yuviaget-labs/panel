...
export async function getSessionUser(request, env) {
  try {
    ...
    const user = await env.DB.prepare('SELECT id, full_name, username, role, balance, validity, panel_code, is_blocked FROM users WHERE id = ?').bind(payload.user_id).first();
